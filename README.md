...
* calvin_extract_numbers.py,jl: extracts the numeric fields of calvin data files in current directory and prints them to stdout in tab separated format. The fields are given below. Only file-id, actions, rel_actions, robot_obs, scene_obs are printed (54 columns).
