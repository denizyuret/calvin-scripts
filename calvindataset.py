...
class CalvinDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        inputs = self.data[np.ix_(range(1+i-self.context_length, 1+i), self.features)]
